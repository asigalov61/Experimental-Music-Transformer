...
Original file is located at
    https://colab.research.google.com/drive/1SNL2AtyycV5kaTJN9b5NDocwVz21LE23
    ...
    try:
        ...
        if file_size <= 1000000:
          ...
          for event in events_matrix:
                  ...
                  event.extend([0]) # patch extension
...
for i in tqdm(range(0, len(filez), 16)):
    ...
    output = Parallel(n_jobs=4, verbose=0)(delayed(TMIDIX_MIDI_Processor)(f) for f in filez[i:i+16])
